    ...
    return(
      <div className="main-container">
       <div className="top-holder">
        <img className="image" src="https://assets.ccbp.in/frontend/react-js/history-website-logo-img.png" alt="app logo"/>
        <div className="search-holder">
         <img className="search-icon" src="https://assets.ccbp.in/frontend/react-js/search-img.png" alt="search"/>
         <input type="search" className="input-element" placeholder="Search history" onChange={this.ChangeFunction} value={searchInput}/>
        </div>
       </div>
          ...
          {newHistoryList.map(eachObject => (
             <li key={eachObject.id} className="items-holder">
              ...
              <div className="icon-holder">
               <img className="logo-element" src={eachObject.logoUrl} alt="domain logo"/>
               <div className="logo-content">
                <p className="name">{eachObject.title}</p>
                <p className="website">{eachObject.domainUrl}</p>
               </div>
              </div>
              <button type="button" className="delete-button" data-testid="delete" onClick={() => this.FillFunction(eachObject.id)}>
               <img className="delete-icon" src="https://assets.ccbp.in/frontend/react-js/delete-img.png" alt="delete"/>
              </button>
             </li>
          ))}
            </ul>
